-- Fix scrap_item_with_replacement function to include all required fields
-- The items table requires fields like remaining_quantity, status, buyer_id, and instance_details
