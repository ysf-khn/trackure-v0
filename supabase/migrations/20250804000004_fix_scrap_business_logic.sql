-- Fix scrap_item_with_replacement function business logic
-- Total scrap: Delete item entirely and decrease order quantity
-- Scrap & Replace: Replacement goes to New Order Items (not workflow)
