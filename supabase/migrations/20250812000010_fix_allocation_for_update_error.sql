-- Fix FOR UPDATE error in allocation function
-- PostgreSQL doesn't allow FOR UPDATE with aggregate functions like SUM()
...
COMMENT ON FUNCTION public.allocate_item_to_workflow IS 'Allocates a quantity of an item from New status to a workflow stage/sub-stage. Uses working_quantity for availability validation. Fixed FOR UPDATE issue with aggregates.';