-- Fix SQL ambiguity error in enhanced_rework_items function
-- The function had ambiguous column references when joining tables with similar column names
        ...
        BEGIN
            ...
            ELSIF (v_item->>'rework_type') = 'backward' THEN
                ...
                BEGIN
                    ...
                    JOIN items itm ON itm.id = isa.item_id
...
COMMENT ON FUNCTION enhanced_rework_items IS 'Fixed version: Processes multiple rework actions including backward movement and scrapping, with proper column qualification to avoid ambiguity';